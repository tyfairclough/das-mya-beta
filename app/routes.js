module.exports = {
  bind: function (app, assetPath) {
    ...
    // SPRINTS
     ...
     app.get('/sprint/:sprint', function (req, res) {
	    res.send(req.params)
		res.render('sprints', {'page_name': page})
    })
    
    app.get('/sprint/:sprint/:page', function (req, res) {
	   // res.send(req.params)
		res.render('sprints/router', {'sprint': req.params.sprint, 'page_name': req.params.page})
		//res.render('sprints/' + req.params.sprint + "/" + req.params.page)
    })
